...
// Display the random joke in the header and populate the joke list if on jokes/index.html
if (getCurrentPage() === "" || getCurrentPage() === "jokes" || getCurrentPage() === "jokes/") {
    // Display the random joke in the header
    document.getElementById('main-joke').innerText = getRandomJoke();

    // Display all jokes in the list
